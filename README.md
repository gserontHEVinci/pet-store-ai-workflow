...
## Objectif
Montrer un workflow de développement assisté par IA centré sur : harnais de tests, règles (`AGENTS.md`), Git/PR/review, lecture d’issue via MCP, et qualité des prompts.
